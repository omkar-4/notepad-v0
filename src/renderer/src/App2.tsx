...
import { PlusCircle, Trash2, Save, FileText, Upload, Eye, Edit } from 'lucide-react'
...
export default function App2() {
  ...
  useEffect(() => {
    const fetchNotes = async () => {
      ...
      setNotes([
        { id: '1', title: 'Welcome', content: 'Welcome to your new notepad!', createdAt: new Date() },
        { id: '2', title: 'How to use', content: 'Click on a note to edit it, or create a new one.', createdAt: new Date() },
      ])
    }
    fetchNotes()
  }, [])
        ...
        {selectedNote ? (
          <>
            ...
            <div className="mb-2 flex justify-between items-center">
              ...
              >
                {isPreview ? <><Edit size={16} className="mr-2" /> Edit</> : <><Eye size={16} className="mr-2" /> Preview</>}
              </button>
            </div>
            {isPreview ? (
              <div
